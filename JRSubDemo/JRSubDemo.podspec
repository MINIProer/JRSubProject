#
#  Be sure to run `pod spec lint JRSubDemo.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # ――― Author Metadata  ――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  spec.author             = { "jiangshulun" => "raylnjiang@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/MINIProer/JRSubProject.git", :tag => "#{spec.version}" }
